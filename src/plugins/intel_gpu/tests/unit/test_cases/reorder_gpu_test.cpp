...
TEST(reorder_weight_gpu_i4, osv32_ignores_memory_past_ofm)
{
    run_reorder_int4_ignores_tail(32, format::os_iyx_osv32, 32);
}

TEST(reorder_weight_gpu_i4, osv32_isv2_ignores_memory_past_ofm)
{
    run_reorder_int4_ignores_tail(32, format::os_is_yx_osv32_isv2, 32);
}

TEST(reorder_weight_gpu_i4, osv64_ignores_memory_past_ofm)
{
